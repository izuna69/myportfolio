  ...
  return (
    <aside className="w-full h-full relative">
      ...
      <div className="flex flex-col overflow-y-scroll h-full pt-48 pb-10 space-y-6 px-6 no-scrollbar text-sm">
        {/* Bio */}
        <div className="mt-6 text-center text-gray-400 text-xs leading-relaxed whitespace-pre-wrap">
          {t.profile.bio}
        </div>
        ...
        <div className="space-y-2">
          <div className="flex justify-between">
            <span className="text-gray-400">{t.labels.residence}</span>
            <span>{t.profile.location}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-400">{t.labels.age}</span>
            <span>{t.profile.age}</span>
          </div>
          <div className="flex justify-between">
            <span className="text-gray-400">{t.labels.email}</span>
        ...
        {/* Languages */}
        <div>
          <h3 className="font-semibold mb-2 text-white">{t.labels.languages}</h3>
          <LanguageChart data={t.profile.languages} />
        </div>
        ...
        {/* Skills */}
        <div>
          <h3 className="font-semibold mb-2 text-white">{t.labels.expertise}</h3>
          <TechStackChart data={t.profile.skills} />
        </div>
        ...
        {/* Tools */}
        <div>
          <h3 className="font-semibold mb-2 text-white">{t.labels.tools}</h3>
          <div className="flex flex-wrap gap-2 mb-5">
            {t.profile.tools.map((tool) => (
              <span
                key={tool}
